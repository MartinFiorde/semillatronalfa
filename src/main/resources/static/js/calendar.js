...
class DatePicker extends HTMLElement {
  ...
  getWeekDaysElementStrings() {
    return this.calendar.weekDays
      .map(weekDay => `<span>${weekDay.substring(0, 1)}</span>`)
      .join('');
  }
  ...
  render() {
    ...
    this.shadow.innerHTML = `
      ...
      <!-- <input type="date" name="fecha" id="input-fecha" value="${date}"> -->
...
//value="2023-06-30"
//value="20:38"
/* document.querySelector('#fecha').value = DatePicker */